    ...
    PII_DETECTED = [
        {
            ...
            "inlines": [
                ...
                {
                    "type": "TextRun",
                    "text": " Please ensure all queries to GovSupport are anonymised.",
                    "italic": True,
                },
            ],
        },
...
def generate_response_card(llm_response):
    """
    Creates a Teams Adaptive card given a GovSupport response
    """
    GovSupport_response = [
    ...
    for i, url in enumerate(urls):
        ...
        GovSupport_response[1]["actions"].append(reference_link)
    ...
    GovSupport_response[0]["text"] = llm_response

    return GovSupport_response
