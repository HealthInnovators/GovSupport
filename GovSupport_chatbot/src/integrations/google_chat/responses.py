...
INTRODUCE_GovSupport_IN_DM = JSONResponse(
    status_code=status.HTTP_200_OK, content=content.INTRODUCE_GovSupport_DM_CARD
)

INTRODUCE_GovSupport_SUPERVISOR_IN_DM = JSONResponse(
    status_code=status.HTTP_200_OK,
    content=content.INTRODUCE_GovSupport_SUPERVISOR_IN_DM,
)


def introduce_GovSupport_in_space(space_name: str) -> JSONResponse:
    """
                                        ...
                                        "columnItems": [
                                            {
                                                ...
                                                "widgets": [
                                                    {
                                                        "textParagraph": {
                                                            "text": content.INTRODUCE_GovSupport_IN_SPACE.format(
                                                    ...
                                                    },
                                                    {
                                                        "decoratedText": {
                                                            ...
                                                            "text": "<b>@GovSupport</b> if you would like my help.",
                                                        }
                                                    },
                                                ],
                                            },
...
def introduce_GovSupport_supervisor_in_space(space_name: str) -> JSONResponse:
    """
    Introduces GovSupport Supervisor in a space
                            ...
                            "widgets": [
                                {
                                    "decoratedText": {
                                        ...
                                        "text": '<font color="#ec0101"><B>GovSupport response rejected<b></font>',
                                    }
                                },
                            ]
                        }
...
def control_group_selection(control_group_message, GovSupport_message) -> dict:
    """
                                                ...
                                                "onClick": {
                                                    "action": {
                                                        ...
                                                        "parameters": [
                                                            {
                                                                "key": "message_event",
                                                                "value": GovSupport_message.model_dump_json(),
                                                            },
                                                        ],
                                                    }
                                                },
                            ...
                            "widgets": [
                                {
                                    "decoratedText": {
                                        ...
                                        "text": '<b><font color="#171738">GovSupport PROCESSING</font></b>',
                                    }
                                },
                                {
                                    "textParagraph": {
