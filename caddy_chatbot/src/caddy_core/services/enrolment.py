from GovSupport_core.utils.tables import offices_table, users_table
from GovSupport_core.models import User
...
def check_domain_status(domain: str):
    """
    Checks if the domain is enrolled with GovSupport
    """
...
def check_user_status(user: str):
    """
    Checks if the user is registered with GovSupport
    """
...
def check_user_call_status(user_record: dict):
    """
    Checks if the user has an active call on GovSupport
    """
